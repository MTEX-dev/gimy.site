...
return [
    ...
    'sites' => [
        ...
        'settings' => [
            'title' => 'Settings',
            'update_info_title' => 'Update Site Information',
            'delete_title' => 'Delete Site',
            'delete_warning_message' => 'Once you delete a site, all of its files, backups, and data will be permanently deleted. To confirm, please type the site\'s slug',
            'delete_button' => 'Delete Site',
            'delete_confirm_title' => 'Confirm Site Deletion',
            'delete_popover_message' => 'Please type the site\'s slug to confirm you want to permanently delete this site:',
            'slug_confirmation_label' => 'Site Slug',
            'update_success' => 'Site settings updated.',
            'slug_mismatch' => 'The provided slug does not match the site\'s slug.',
