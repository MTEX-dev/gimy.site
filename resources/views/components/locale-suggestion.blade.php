@if (session('suggested_locale'))
    <div
        ...
        class="fixed inset-0 z-50 flex items-end justify-center px-4 py-6 pointer-events-none sm:items-start sm:justify-end"
        aria-live="assertive"
    >
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3 w-0 flex-1 pt-0.5">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            {{ __('strings.language_suggestion_text', ['language' => \Illuminate\Support\Str::ucfirst(trans('strings.'.session('suggested_locale')))]) }}
                        </p>
