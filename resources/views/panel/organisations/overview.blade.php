            ...
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6 flex items-center space-x-4">
                        ...
                        @else
                            <div
                                class="flex h-16 w-16 items-center justify-center rounded-full bg-gray-200 text-2xl font-bold text-gray-500 dark:bg-gray-700 dark:text-gray-400">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                            @foreach ($organisation->sites as $org_site)
                                <div class="rounded-lg bg-gray-50 p-4 shadow dark:bg-gray-700">
                                    ...
                                    <a href="{{ route('panel.sites.overview', ['site' => $org_site, $organisation]) }}"
